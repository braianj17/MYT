...
<div class="container-fluid">
  <div class="row">
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
      ...
      <h2>Tablero de edicion</h2>
      <div class="col-md-8 order-md-1">
      <form class="needs-validation" action="insert.php" method="GET" novalidate>
      ...
      <h4 class="mb-3">Informacion del producto</h4>
        <div class="row">
          ...
          <div class="col-md-6 mb-3">
            <input type="text" class="form-control" id="" name="Precio" placeholder="Precio" value="" required>
            <div class="invalid-feedback">
            Se requiere informacion.
            </div>
          </div>
        ...
        <div class="mb-3">
          <input type="text" class="form-control" id="" name="Descripcion" placeholder="Descripcion" value="" required>
        ...
        <div class="row">
          <div class="col-md-5 mb-3">
            ...
            <select class="custom-select d-block w-100" id="" name="categoria" value="" >
              <option >Elige...</option>
          ...
          <input type="text" class="form-control" id="" name="Imagen" placeholder="upload/ejemplo.JPGE" value="" required>
          <div class="invalid-feedback">Se requiere informacion </div>
        </div>
        </div>
